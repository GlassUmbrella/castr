...
var singleton = function singleton(){
    ...
    function init() {
		...
		var podcastUserModel = require("../models/podcast-user");
		var episodeModel = require("../models/episode");
		
		var options = {};
		
		models["Users"] = sequelize.define("Users", userModel.model, options);
		models["Podcasts"] = sequelize.define("Podcast", podcastModel.model, options);
		models["PodcastUsers"] = sequelize.define("PodcastUsers", podcastUserModel.model, options);
		models["Episodes"] = sequelize.define("Episode", episodeModel.model, options);
		
		relationships["Users"] = userModel.relations;
		relationships["Podcasts"] = podcastModel.relations;
		relationships["PodcastUsers"] = podcastUserModel.relations;
