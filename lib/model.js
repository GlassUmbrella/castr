...
var singleton = function singleton(){
    ...
    function init() {
		...
		models["Users"] = sequelize.define("Users", userModel, options);
		models["Podcasts"] = sequelize.define("Podcast", podcastModel, options);
		models["PodcastUsers"] = sequelize.define("PodcastUsers", podcastUserModel, options);
		models["Episodes"] = sequelize.define("Episode", episodeModel, options);
		
		relationships["Users"] = userModel.relations;
		relationships["Podcasts"] = podcastModel.relations;
		relationships["PodcastUsers"] = podcastUser.relations;
