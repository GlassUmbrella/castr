...
var singleton = function singleton(){
    ...
    function init() {
		...
		models["User"] = sequelize.define("User", userModel.model, options);
		models["Podcast"] = sequelize.define("Podcast", podcastModel.model, options);
		models["PodcastUser"] = sequelize.define("PodcastUser", podcastUserModel.model, options);
		models["Episode"] = sequelize.define("Episode", episodeModel.model, options);
		
		relationships["User"] = userModel.relations;
		relationships["Podcast"] = podcastModel.relations;
		relationships["PodcastUser"] = podcastUserModel.relations;
